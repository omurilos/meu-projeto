...
class tratamentos:
     ...
     def __init__(self, root_pai):
          ...
          frame_infos = ctk.CTkFrame(self.filho, width=970, height=500, fg_color="#D1CECE", corner_radius=18)
          frame_infos.pack(padx=20, pady=5)
          frame_infos.pack_propagate(False)


          ctk.CTkLabel(frame_infos, text='💊 Tratamento', bg_color="#D1CECE", width=50, text_color='#F05933', font=('Arial', 30, 'bold')).grid(column=1, columnspan=2, row=0, pady=20)

          ctk.CTkLabel(frame_infos, text='Ocorrências', text_color="#383838", font=('Arial', 18, 'bold')).grid(column=0, row=1, pady=10)
          ctk.CTkEntry(frame_infos, text_color="#383838", fg_color='#FFFFFF', border_color="#CACACA", width=150 ).grid(column=1, row=1, padx=10, pady=10)

          ctk.CTkLabel(frame_infos, text='Produto', text_color="#383838", font=('Arial', 18, 'bold')).grid(column=2, row=1, padx=70, pady=5)
          ctk.CTkEntry(frame_infos, text_color="#383838", fg_color='#FFFFFF', border_color="#CACACA", width=150 ).grid(column=3, row=1, padx=10, pady=10)

          ctk.CTkLabel(frame_infos, text='Dose', text_color="#383838", font=('Arial', 18, 'bold')).grid(column=0, row=2, padx=10, pady=10)
          ctk.CTkEntry(frame_infos, text_color="#383838", fg_color='#FFFFFF', border_color="#CACACA", width=150 ).grid(column=1, row=2, padx=10, pady=10)

          ctk.CTkLabel(frame_infos, text='Responsavel', text_color="#383838", font=('Arial', 18, 'bold')).grid(column=2, row=2, padx=10, pady=10)
          ctk.CTkEntry(frame_infos, text_color="#383838", fg_color='#FFFFFF', border_color="#CACACA", width=150 ).grid(column=3, row=2, padx=10, pady=10)    



          frame_tabela = LabelFrame(self.filho, text='' , fg="green", padx=10, pady=10)
          frame_tabela.pack(fill=BOTH, expand=False, pady=1)
          ...
          tabela.column('doenca', width=80)
          tabela.column('cultura', width=80)
          tabela.column('area', width=80)
